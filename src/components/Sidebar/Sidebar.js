...
export default function Sidebar() {
  ...
  const { selectedOrg, selectedProject } = useMain();

  // Sugestão: Separe os links em um componente para evitar repetição e tornar o código mais legível.
  const NavigationLink = ({ href, iconClass, label }) => {
  ...
  {`PROJ: ${selectedProject.name ? selectedProject.name : 'Nenhum projeto selecionado'}`}
              ...
              <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                <li className="items-center">
                  <NavigationLink
                    href={`/services/sales/pdv?project=${selectedOrg.id}`}
                ...
                <li className="items-center">
                  <NavigationLink
                    href={`/services/sales/stock?project=${selectedOrg.id}`}
                    iconClass="fas fa-map-marked"
                    label="Estoque"
                  />
                </li>
                <li className="items-center">
                  <NavigationLink
                    href={`/services/sales/custommers?project=${selectedOrg.id}`}
                    iconClass="fas fa-map-marked"
                    label="Clientes"
                  />
                </li>
                <li className="items-center">
                  <NavigationLink
                    href={`/services/sales/products?project=${selectedOrg.id}`}
                    iconClass="fas fa-map-marked"
